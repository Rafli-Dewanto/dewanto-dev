...
export default function About() {
  const sectionTitle = "about me" as const;
  return (
    <SectionHeading sectionTitle={sectionTitle}>
      <p className="mb-4">
        ...
        technology.In a rapidly changing digital landscape, my fascination with
        both web and Android development has led me on a captivating voyage of
        discovery.
      </p>
